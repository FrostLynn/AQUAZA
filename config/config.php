...
function hapusToko($id) 
{
    ...
    mysqli_query($conn, "DELETE FROM store WHERE id_store = $id");
    return mysqli_affected_rows($conn);
...
function tambahGaleriToko($data)
{
    global $conn;
    $name = $data["name"];
    $photo = upload();
    ...
    $query = "INSERT INTO store_galleries
                VALUES
                ('', '$photo', '$name')
            ";
...
function updateGaleriToko($data)
{
    global $conn;
    ...
    $query = "UPDATE store_galleries SET
                photos = '$photo',
                store_id = '$name'
                WHERE id_gallery = $id
            ";
...
function hapusGalleryToko($id) 
{
    global $conn;

    mysqli_query($conn, "DELETE FROM store_galleries WHERE id_gallery = $id");
    return mysqli_affected_rows($conn);
...
function tambahCategoryToko($data)
{
    global $conn;
    $name = $data["name"];
    $slug = slug($name);
...
function updateCategoryToko($data)
{
    global $conn;
    ...
    $query = "UPDATE store_categories SET
                category_name = '$name',
                slug = '$slug'
                WHERE id = $id
            ";
...
function hapusCategoriToko($id)
{
    global $conn;

    mysqli_query($conn, "DELETE FROM store_categories WHERE id = $id");
    return mysqli_affected_rows($conn);
}

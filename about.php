        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <h1 class="" style="font-size: 60px;">AQUAZA</h1>
              <h5 class="">Pesan Antar-Galon Online</h5>
              <a
                  href="https://wa.me/6281398910725"
                  target="_blank"
      ...
      <section class="store-adventeges" id="adventeges">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <h2 class="font-weight-bold mb-2">AQUAZA</h2>   
              <hr style="border-top: 5px solid black; width: 80px;">
            </div>
          </div>
          <div class="row text-center">
            <div class="col-md-12">
              <p>AQUAZA merupakan website pesan-antar galon secara online yang dapat memudahkan para customer untuk memesan galon hanya dari rumah. Selain itu, website ini membantu memudahkan para penggunanya untuk melihat-lihat depot air minum mana yang paling dekat dengan tempat tinggalnya yang juga disertai dengan harga, sehingga tidak perlu lagi meakukan survey tempat secara manual atau bertanya harga kepada penjual secra manual.</p>
            </div>
          </div>
          ...
          <div class="row justify-content-center text-center">
            <div class="col-md-6">
                <h5>Visi</h5>
                <p>Memudahkan warga sekitar Kampus 2 Universitas Siliwangi Tasikmalaya untuk menemukan depot air minum terdekat dan secara online</p>
            </div>
            <div class="col-md-6">
                <h5>Misi</h5>
                <p>Melayani pesan-antar galon berbasis website secara online</p>
            </div>
          </div>
        </div>
      </section>

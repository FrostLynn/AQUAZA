        ...
        <div class="container">
          <div class="row align-items-center row-login justify-content-center">
            <div class="col-lg-6 text-center">
              ...
              <p>
                Silahkan masuk ke "Dashboard Saya" kemudian kirim foto bukti transaksi di dahsboard transaksi anda dan
                silahkan tunggu konfirmasi dari agen.
              </p>
              <div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">
            2023 Copyright by AQUAZA. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>

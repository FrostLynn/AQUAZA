  ...
  <div class="page-content page-cart">
            ...
            <nav>
              <ol class="breadcrumb bg-transparent">
                <li class="breadcrumb-item">
                  <a href="/app-pesan-antar-galon/index.php">Store</a>
                </li>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select name="city" id="city" class="form-control" required>
                  <option value="Mugarsari">Mugarsari</option>
                </select>
              </div>
            </div>
            <div class="col-md-4">
    ...
    <footer>
      <div class=" container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">&copy; <?= date('Y'); ?> 2023 Copyright by AQUAZA. All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </footer>
